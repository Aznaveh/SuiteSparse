...
// sets all default control settings:
ParU_Res paru_init(paru_control *);

// a routine that does init_row and also factorization
ParU_Res paru_analyze(cholmod_sparse *A, paru_symbolic **S_handle, paru_control *);

ParU_Res paru_factorize(cholmod_sparse *A, paru_symbolic *LUsym, paru_matrix **paruMatInfo_handle, paru_control *);

ParU_Res paru_solve(double *b, paru_matrix *paruMatInfo, paru_control *);

ParU_Res paru_solve(double *B, Int n, paru_matrix *paruMatInfo, paru_control *);

ParU_Res paru_freesym(paru_symbolic **LUsym_handle, paru_control *);
ParU_Res paru_freemat(paru_matrix **paruMatInfo_handle, paru_control *);

ParU_Res paru_residual(double *b, double &resid, double &norm,
        cholmod_sparse *A, paru_matrix *paruMatInfo, paru_control *);
                              
ParU_Res paru_residual(cholmod_sparse *A, paru_matrix *paruMatInfo,
                              double *b, double *Results, Int n, paru_control *);
